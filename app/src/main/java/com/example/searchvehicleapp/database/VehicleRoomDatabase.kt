...
@Database(entities = [Vehicle::class, TypeOfVehicle::class], version = 1, exportSchema = false)
        ...
        fun getDatabase(context: Context): VehicleRoomDatabase {
            ...
            return INSTANCE ?: synchronized(this) {
                val instance = Room.databaseBuilder(
                    context.applicationContext, VehicleRoomDatabase::class.java, "vehicle_database"
